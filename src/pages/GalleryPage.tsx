    ...
    <>
      ...
      <div className="bg-[var(--color-primary-600)] text-white py-16">
        <div className="container-wide px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4">Our Gallery</h1>
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full text-sm font-bold transition-all ${
                selectedCategory === cat 
                  ? 'bg-[var(--color-primary-600)] text-white shadow-lg shadow-blue-200' 
            ...
            <AnimatePresence mode='popLayout'>
              {filteredImages.map((img) => (
                <motion.div
                  ...
                  className="group relative aspect-square bg-slate-100 rounded-xl md:rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all cursor-pointer"
