...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Show when near top, otherwise hide when scrolling down
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.a
          ...
          className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-12 h-12 bg-[#25D366] text-white rounded-full shadow-2xl hover:scale-110 active:scale-95 group"
